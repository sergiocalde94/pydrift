# -*- coding: utf-8 -*-
#
# pydrift documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'Data-And-Model-Drift-Checkerdoc'
...
latex_documents = [
    ('index',
     'Data-And-Model-Drift-Checker.tex',
     u'pydrift Documentation',
     u"Sergio Calderón Pérez-Lozao", 'manual'),
]
...
man_pages = [
    ('index', 'Data-And-Model-Drift-Checker', u'pydrift Documentation',
     [u"Sergio Calderón Pérez-Lozao"], 1)
]
...
texinfo_documents = [
    ('index', 'Data-And-Model-Drift-Checker', u'pydrift Documentation',
     u"Sergio Calderón Pérez-Lozao", 'pydrift',
